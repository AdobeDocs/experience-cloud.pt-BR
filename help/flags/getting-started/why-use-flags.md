---
title: Por que usar sinalizadores
...
# Por que usar sinalizadores {#why-use}

Os Sinalizadores são a ferramenta certa sempre que você precisa controlar quem vê um recurso e quando — se você está testando no desenvolvimento, validando com um subconjunto de usuários ou coordenando uma versão grande em várias equipes.
