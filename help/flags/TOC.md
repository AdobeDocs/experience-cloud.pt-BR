...
+ Introdução {#get-started}
   ...
   + [Modos de sinalizadores](getting-started/flags-modes.md)
+ Conceitos {#concepts}
...
+ Sinalizadores de integração {#integrate}
   + [Sinalizadores de integração no aplicativo](guides/integrate/integrating-in-your-app.md)
...
+ Importar sinalizadores de recursos {#import}
