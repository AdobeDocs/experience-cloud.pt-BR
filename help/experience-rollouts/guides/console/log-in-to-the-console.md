...
A introdução às implantações de experiência envolve três etapas: encontrar ou criar sua equipe, solicitar acesso e fazer logon no console.
...
## Fazer logon no console {#log-in-steps}
...
Depois de fazer logon, verifique se o aplicativo está listado no console. Os aplicativos são gerenciados por administradores de equipe. Se seu aplicativo não estiver listado, entre em contato com o administrador da equipe para adicioná-lo. Consulte [Gerenciar aplicativos](../applications/manage-applications.md) para obter mais informações.
